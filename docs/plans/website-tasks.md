...
| ~~Typeset/prose outside contract.~~ **Resolved:** RECIPE-007 added typeset (11 slots) and prose (1 slot) to the canonical contract; all three emitters pass.                                                                                        | `RECIPE-007` |
