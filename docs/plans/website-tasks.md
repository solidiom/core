...
| M3 Public beta platform   | In progress | G3   | RECIPE-001 complete: canonical recipe contract, semantic vocabulary (14 attributes, 33 scopes, 8 flags, 9 recorded exceptions), 48 token identities, exception model, validator, and Button/Switch/Dialog reference definitions, published as `docs/contracts/recipe-contract.md` and enforced by `gate:phase1` §9 on every pull request. Remaining M3 work: RECIPE-002..006, CLI-001..010, THEME-001..005, BUILDER-001..006, BETA-001..003. |
