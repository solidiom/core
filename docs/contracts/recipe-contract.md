...
**Contract version:** 1
**Status authority:** The contract and emitters are implemented; current audit, build, and parity status is tracked only in `docs/plans/website-tasks.md` §7 and §11.1.
**Task history:** `RECIPE-001..004` are recorded in `docs/plans/website-tasks.md` §2.1 and `docs/history/plans/website-m0-m3.md`.
...
These commands participate in `gate:phase1` §9. Current workflow trigger policy and pass/fail status are owned by `docs/plans/website-tasks.md`; this contract does not claim that they run on every pull request.
