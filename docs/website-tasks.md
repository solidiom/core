...
| M1 Foundation/alpha shell | In progress | G1   | SITE-001 scaffold, SITE-002 targets, SITE-003 static baseline, and SITE-004 base layout/bootstrap validated (tokens/fonts are placeholders pending BRAND-002/BRAND-003); remaining shell work pending |
