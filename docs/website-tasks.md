...
| Status | ID       | Size | Depends on                     | Owner area    | Task and acceptance boundary                                                                                                         |
| ------ | -------- | ---- | ------------------------------ | ------------- | ------------------------------------------------------------------------------------------------------------------------------------ |
| [ ]    | SITE-001 | S    | —                              | Platform      | Create `apps/site` using only POC configuration/integration wiring; package name `@solidiom/site`; retain POC unchanged.             |
...
| M1 Foundation/alpha shell | Not started | G1   | Site build, preview, shell tests                 |
