...
- Familiarity with Solid 2 beta patterns (see `docs/solid2-migration-notes.md`)
...
| Mistake                                          | Fix                                                                         |
| ------------------------------------------------ | --------------------------------------------------------------------------- |
| `import { type JSX } from "solid-js"`            | Use `"@solidjs/web"` — see `docs/solid2-migration-notes.md`                 |
