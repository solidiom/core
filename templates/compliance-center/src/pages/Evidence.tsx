...
const EVIDENCE: EvidenceItem[] = [
  { id: "e1", name: "Access Review Q2 2025", control: "CC6.1 — Logical Access", owner: "Alice Chen", status: "verified", uploaded: "2025-07-10", expires: "2026-01-10" },
  { id: "e2", name: "Penetration Test Report", control: "CC7.2 — System Monitoring", owner: "Bob Martinez", status: "verified", uploaded: "2025-06-15", expires: "2025-12-15" },
  { id: "e3", name: "Incident Response Plan", control: "A.16.1 — Incident Management", owner: "Carol Wu", status: "pending", uploaded: "2025-07-28", expires: "2026-01-28" },
  { id: "e4", name: "Employee Background Checks", control: "164.308 — Security Mgmt", owner: "Eva Singh", status: "missing", uploaded: "—", expires: "2025-09-01" },
  { id: "e5", name: "Data Encryption Audit", control: "A.8.24 — Crypto Controls", owner: "Frank Lee", status: "expired", uploaded: "2025-01-20", expires: "2025-07-20" },
  { id: "e6", name: "Backup Recovery Test", control: "CC9.4 — Recovery Testing", owner: "Henry Zhao", status: "verified", uploaded: "2025-07-01", expires: "2026-01-01" },
  { id: "e7", name: "Vendor Risk Assessment", control: "A.15.1 — Supplier Relationships", owner: "Iris Tanaka", status: "pending", uploaded: "2025-08-02", expires: "2026-02-02" },
  { id: "e8", name: "Security Training Records", control: "CC6.3 — Awareness", owner: "Jack Wilson", status: "verified", uploaded: "2025-06-30", expires: "2025-12-30" },
]
    ...
    <div class="space-y-8">
        ...
        <div>
          <Breadcrumb.Root class="mb-2">
            <Breadcrumb.List class="flex items-center gap-1.5 text-sm text-gray-500">
              ...
              <Breadcrumb.Item>
                <Breadcrumb.Link href="/evidence" current class="text-gray-900 font-medium">Evidence</Breadcrumb.Link>
              </Breadcrumb.Item>
            </Breadcrumb.List>
          </Breadcrumb.Root>
        ...
        <Dialog.Root open={open} onOpenChange={setOpen}>
          ...
          <Dialog.Portal>
            ...
            <Dialog.Content class="fixed left-1/2 top-1/2 w-full max-w-md -translate-x-1/2 -translate-y-1/2 rounded-lg bg-white p-6 shadow-xl">
              <Dialog.Title class="text-lg font-semibold text-gray-900">Upload Evidence</Dialog.Title>
      ...
      <Alert.Root type="info" class="rounded-md border border-blue-200 bg-blue-50 p-4">
        ...
        <Alert.Description class="mt-1 text-sm text-blue-700">
          {EVIDENCE.filter((e) => e.status === "verified").length} verified, {EVIDENCE.filter((e) => e.status === "pending").length} pending, {EVIDENCE.filter((e) => e.status === "missing").length} missing, {EVIDENCE.filter((e) => e.status === "expired").length} expired.
        </Alert.Description>
      </Alert.Root>
