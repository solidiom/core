...
const INTEGRATIONS = [
  {
    ...
    description: "Automate user provisioning and de-provisioning via SCIM 2.0.",
    enabled: true,
    provider: "Okta",
  },
  {
    name: "SAML 2.0",
    description: "Configure SAML identity provider for single sign-on.",
    enabled: true,
    provider: "Azure AD",
  },
  {
    name: "Directory Sync",
    description: "Sync groups and roles from your LDAP directory.",
    enabled: false,
    provider: "Microsoft AD",
  },
  {
    name: "Webhook Endpoint",
    description: "Send event notifications to your custom webhook URL.",
    enabled: true,
    provider: "Custom",
  },
]
    ...
    <div class="space-y-8">
      <div>
        <Breadcrumb.Root class="mb-2">
          <Breadcrumb.List class="flex items-center gap-1.5 text-sm text-gray-500">
            ...
            <Breadcrumb.Item>
              <Breadcrumb.Link href="/integrations" current class="text-gray-900 font-medium">
                Integrations
              </Breadcrumb.Link>
            </Breadcrumb.Item>
          </Breadcrumb.List>
        ...
        <div class="flex items-center justify-between">
          <div>
            ...
            <p class="mt-1 text-sm text-gray-500">
              Manage SCIM provisioning, SAML, directory sync, and webhook configurations.
            </p>
          </div>
        </div>
      </div>
      ...
      <Alert.Root type="info" class="rounded-md border border-blue-200 bg-blue-50 p-4">
        ...
        <Alert.Description class="mt-1 text-sm text-blue-700">
          SCIM provisioning has been successfully syncing for the past 30 days. Last sync: 4 hours
          ago.
        </Alert.Description>
      </Alert.Root>
