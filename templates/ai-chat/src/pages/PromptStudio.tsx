...
const SAVED_PROMPTS = [
  {
    id: "1",
    name: "Code Reviewer",
    template: "Review this code for bugs and best practices: {code}\nLanguage: {language}",
  ...
  },
  {
    ...
    variables: ["recipient", "topic", "tone", "points"],
    updatedAt: "1 day ago",
  },
  {
    id: "3",
  ...
  },
  {
    ...
    variables: ["topic", "audience", "style", "word_count"],
      ...
      <div>
        <Breadcrumb.Root class="mb-2">
          <Breadcrumb.List class="flex items-center gap-1.5 text-sm text-gray-500">
            ...
            <Breadcrumb.Item>
              <Breadcrumb.Link href="/prompts" current class="text-gray-900 font-medium">
                Prompts
              </Breadcrumb.Link>
            </Breadcrumb.Item>
          </Breadcrumb.List>
        ...
        <p class="mt-1 text-sm text-gray-500">
          Design, test, and manage prompts with variable interpolation.
        </p>
      </div>
