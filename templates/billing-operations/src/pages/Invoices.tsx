...
const INVOICES = [
  { id: "INV-001", client: "Acme Corp", amount: "$1,250.00", status: "paid" as const, dueDate: "2026-07-15", issuedDate: "2026-06-15" },
  { id: "INV-002", client: "Globex Inc", amount: "$3,400.00", status: "pending" as const, dueDate: "2026-08-20", issuedDate: "2026-07-20" },
  { id: "INV-003", client: "Initech LLC", amount: "$875.00", status: "overdue" as const, dueDate: "2026-07-01", issuedDate: "2026-06-01" },
  { id: "INV-004", client: "Umbrella Co", amount: "$5,200.00", status: "paid" as const, dueDate: "2026-07-30", issuedDate: "2026-06-30" },
  { id: "INV-005", client: "Stark Ind", amount: "$12,750.00", status: "draft" as const, dueDate: "2026-09-01", issuedDate: "2026-08-01" },
  { id: "INV-006", client: "Wayne Ent", amount: "$2,100.00", status: "pending" as const, dueDate: "2026-08-25", issuedDate: "2026-07-25" },
]
    ...
    <div>
      <Breadcrumb.Root class="mb-4">
        <Breadcrumb.List class="flex items-center gap-2">
          ...
          <Breadcrumb.Item>
            <Breadcrumb.Link href="/" current class="text-sm font-medium text-gray-900">Invoices</Breadcrumb.Link>
          </Breadcrumb.Item>
        </Breadcrumb.List>
      </Breadcrumb.Root>
      ...
      <div class="flex items-center justify-between">
        <div>
          ...
          <p class="mt-1 text-sm text-gray-500">Manage invoices, track payment status, and handle disputes.</p>
        </div>
