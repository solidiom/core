...
const EVENTS: Event[] = [
  {
    ...
    severity: "critical",
    source: "api-gateway",
    message: "Connection pool exhausted — 503 errors detected",
  },
  {
    id: "evt-002",
    ...
    message: "Response latency exceeded 300ms threshold",
  },
  {
    id: "evt-003",
  ...
  },
  {
    ...
    message: "Queue depth approaching 80% capacity",
  },
  {
    id: "evt-005",
    ...
    severity: "critical",
    source: "cdn-edge",
    message: "Origin server timeout — fallback cache activated",
  },
  {
    id: "evt-006",
    ...
    message: "Batch email delivery completed: 1,240 messages",
  },
  {
    id: "evt-007",
    timestamp: "2024-03-15 14:18:42",
    severity: "debug",
    source: "search-indexer",
    message: "Index rebuild started for product catalog",
  },
  {
    id: "evt-008",
    timestamp: "2024-03-15 14:15:09",
    severity: "info",
    source: "api-gateway",
    message: "Auto-scaling triggered: 4 → 6 instances",
  },
  {
    id: "evt-009",
    timestamp: "2024-03-15 14:12:55",
    severity: "warning",
    source: "payment-processor",
    message: "Retry rate above 5% for merchant endpoints",
  },
  {
    id: "evt-010",
      ...
      <div>
        <Breadcrumb.Root class="mb-2">
          <Breadcrumb.List class="flex items-center gap-1.5 text-sm text-gray-500">
            ...
            <Breadcrumb.Item>
              <Breadcrumb.Link href="/events" current class="text-gray-900 font-medium">
                Events
              </Breadcrumb.Link>
            </Breadcrumb.Item>
          </Breadcrumb.List>
        ...
        <p class="mt-1 text-sm text-gray-500">
          Real-time event stream with filtering and severity badges.
        </p>
      </div>
