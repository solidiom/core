...
const METRICS = [
  { title: "Uptime", value: "99.97%", change: "+0.02% from last week", changeType: "positive" as const },
  { title: "Error Rate", value: "0.12%", change: "-0.03% from last week", changeType: "positive" as const },
  { title: "Avg Latency", value: "42ms", change: "-5ms from last week", changeType: "positive" as const },
  { title: "Active Alerts", value: "3", change: "+1 from last hour", changeType: "negative" as const },
]
  ...
  return (
    <div class="space-y-8">
        ...
        <div>
          <Breadcrumb.Root class="mb-2">
            <Breadcrumb.List class="flex items-center gap-1.5 text-sm text-gray-500">
              ...
              <Breadcrumb.Item>
                <Breadcrumb.Link href="/" current class="text-gray-900 font-medium">Overview</Breadcrumb.Link>
              </Breadcrumb.Item>
            </Breadcrumb.List>
          </Breadcrumb.Root>
          <h1 class="text-2xl font-bold text-gray-900">Overview</h1>
          <p class="mt-1 text-sm text-gray-500">System health, performance metrics, and service status at a glance.</p>
        </div>
      ...
      <Alert.Root type="warning" class="rounded-md border border-yellow-200 bg-yellow-50 p-4">
        <Alert.Title class="text-sm font-medium text-yellow-800">Degraded Service Detected</Alert.Title>
            ...
            <table class="min-w-full divide-y divide-gray-200">
              <thead class="bg-gray-50">
                <tr>
                  ...
                  <th class="px-6 py-3 text-left text-xs font-medium uppercase tracking-wider text-gray-500">Latency</th>
              ...
              <tbody class="divide-y divide-gray-200 bg-white">
                {SERVICES.map((service) => (
                  <tr class="hover:bg-gray-50">
                    ...
                    <td class="whitespace-nowrap px-6 py-4 text-sm text-gray-500">{service.latency}</td>
                    <td class="whitespace-nowrap px-6 py-4 text-sm text-gray-500">{service.region}</td>
                  </tr>
                ))}
              </tbody>
            </table>
            ...
            <table class="min-w-full divide-y divide-gray-200">
              <thead class="bg-gray-50">
                <tr>
                  ...
                  <th class="px-6 py-3 text-right text-xs font-medium uppercase tracking-wider text-gray-500">Time</th>
                </tr>
              </thead>
              <tbody class="divide-y divide-gray-200 bg-white">
                <tr class="hover:bg-gray-50">
                  <td class="whitespace-nowrap px-6 py-4 text-sm font-medium text-gray-900">Alice Chen</td>
                  <td class="whitespace-nowrap px-6 py-4 text-sm text-gray-500">deployed</td>
                  <td class="whitespace-nowrap px-6 py-4 text-sm text-gray-500">api-gateway v2.4.1</td>
                  <td class="whitespace-nowrap px-6 py-4 text-right text-sm text-gray-400">2 min ago</td>
                </tr>
                <tr class="hover:bg-gray-50">
                  <td class="whitespace-nowrap px-6 py-4 text-sm font-medium text-gray-900">Bob Martinez</td>
                  <td class="whitespace-nowrap px-6 py-4 text-sm text-gray-500">scaled</td>
                  <td class="whitespace-nowrap px-6 py-4 text-sm text-gray-500">worker-pool to 8 replicas</td>
                  <td class="whitespace-nowrap px-6 py-4 text-right text-sm text-gray-400">15 min ago</td>
                </tr>
                <tr class="hover:bg-gray-50">
                  <td class="whitespace-nowrap px-6 py-4 text-sm font-medium text-gray-900">Carol Wu</td>
                  <td class="whitespace-nowrap px-6 py-4 text-sm text-gray-500">updated</td>
                  <td class="whitespace-nowrap px-6 py-4 text-sm text-gray-500">auth-service config</td>
                  <td class="whitespace-nowrap px-6 py-4 text-right text-sm text-gray-400">1 hour ago</td>
                </tr>
              </tbody>
            </table>
          </div>
