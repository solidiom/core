...
const MOCK_RESULTS = [
  {
    ...
    snippet:
      "Learn the fundamentals of Solid.js, a declarative JavaScript library for building user interfaces with fine-grained reactivity.",
    url: "docs.solidjs.com/guide/getting-started",
    date: "Aug 5, 2026",
  },
  {
    title: "Building Search with Solidiom",
    snippet:
      "A complete guide to implementing full-text search in your Solidiom application with filters and facets.",
    url: "blog.solidiom.com/search-guide",
    date: "Jul 22, 2026",
  },
  {
    title: "SolidJS Router Documentation",
    snippet:
      "Type-safe client-side routing for Solid.js applications with nested routes and data loading.",
    url: "docs.solidjs.com/router",
    date: "Jun 10, 2026",
  },
]
    ...
    <div class="space-y-8">
      ...
      <div>
        ...
        <p class="mt-1 text-sm text-gray-500">
          Full-text search with filters, facets, and ranked results.
        </p>
      </div>
      ...
      <Alert.Root type="info" class="rounded-md border border-blue-200 bg-blue-50 p-4">
        ...
        <Alert.Description class="mt-1 text-sm text-blue-700">
          Found {MOCK_RESULTS.length} results for "{query()}". Refine your search using filters
          below.
        </Alert.Description>
      </Alert.Root>
        ...
        <div class="lg:col-span-3">
          <Field.Root>
            ...
            <Field.Description class="mt-1 text-xs text-gray-500">
              Enter a search term to find content matching your criteria.
            </Field.Description>
          </Field.Root>
