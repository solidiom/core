...
const POLICIES: Policy[] = [
  {
    ...
    description: "Require minimum 12 characters with mixed case, numbers, and special characters",
    scope: "All Users",
    enforced: true,
  ...
  },
  {
    ...
    description: "Automatically terminate inactive sessions after 30 minutes",
    scope: "All Users",
    enforced: true,
  ...
  },
  {
    ...
    description: "Production and development environments must be on separate network segments",
  ...
  },
  {
    ...
    description: "Limit API requests to 1000 per minute per client",
    scope: "API Services",
    enforced: false,
  ...
  },
  {
    ...
    description: "Retain audit logs for a minimum of 90 days",
    scope: "All Systems",
    enforced: true,
  ...
  },
  {
    ...
    description: "Run automated vulnerability scans on all production assets weekly",
    scope: "Production",
    enforced: false,
  ...
  },
  {
    id: "POL-009",
    name: "Access Review",
    description: "Conduct quarterly access reviews for all privileged accounts",
    scope: "Admin Users",
    enforced: true,
  ...
  },
  {
    ...
    description: "Critical incidents must be acknowledged within 15 minutes",
    scope: "Security Team",
    enforced: true,
...
export function Policies(): JSX.Element {
  ...
  const togglePolicy = (id: string) => {
    setPolicies((prev) =>
      prev.map((policy) => (policy.id === id ? { ...policy, enforced: !policy.enforced } : policy)),
    )
  }
      ...
      <div>
        <Breadcrumb.Root class="mb-2">
          <Breadcrumb.List class="flex items-center gap-1.5 text-sm text-gray-500">
            ...
            <Breadcrumb.Item>
              <Breadcrumb.Link href="/policies" current class="text-gray-900 font-medium">
                Policies
              </Breadcrumb.Link>
            </Breadcrumb.Item>
          </Breadcrumb.List>
        ...
        <p class="mt-1 text-sm text-gray-500">
          Define, enforce, and audit security policies across the organization.
        </p>
      </div>
      ...
      <Card.Root class="rounded-lg border border-gray-200 bg-white shadow-sm">
        <Card.Header class="flex items-center justify-between border-b border-gray-200 px-6 py-4">
          ...
          <span class="text-sm text-gray-500">
            {enforcedCount()} of {policies().length} enforced
          </span>
        </Card.Header>
