...
const RUNBOOKS: Runbook[] = [
  ...
  {
    id: "RB-007",
    title: "Data Corruption Remediation",
    category: "Application",
    steps: 9,
  ...
  {
    id: "RB-008",
    title: "Compromised Server Isolation",
    category: "Security",
    steps: 15,
    ...
    <div class="space-y-6">
      <div>
        <Breadcrumb.Root class="mb-2">
          <Breadcrumb.List class="flex items-center gap-1.5 text-sm text-gray-500">
            ...
            <Breadcrumb.Item>
              <Breadcrumb.Link href="/runbooks" current class="text-gray-900 font-medium">
                Runbooks
              </Breadcrumb.Link>
            </Breadcrumb.Item>
          </Breadcrumb.List>
        ...
        <p class="mt-1 text-sm text-gray-500">
          Step-by-step operational runbooks for common incident scenarios.
        </p>
      </div>
      ...
      <Card.Root class="rounded-lg border border-gray-200 bg-white shadow-sm">
        <Card.Header class="flex flex-wrap items-center gap-4 border-b border-gray-200 px-6 py-4">
          ...
          <Select.Root
            defaultValue="all"
            onValueChange={(v) => setCategoryFilter(Array.isArray(v) ? v[0] : v)}
          >
            ...
            <Select.Content class="z-50 min-w-[8rem] overflow-hidden rounded-md border border-gray-200 bg-white p-1 shadow-md">
              <Select.Item
                value="all"
                class="relative flex w-full cursor-default select-none items-center rounded-sm px-2 py-1.5 text-sm outline-none focus:bg-gray-100"
              >
                All Categories
              </Select.Item>
              <Select.Item
