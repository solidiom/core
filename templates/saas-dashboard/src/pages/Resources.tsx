...
const RESOURCES: Resource[] = [
  { id: "res-001", name: "api-gateway", type: "Service", status: "running", region: "us-east-1", created: "2024-01-15" },
  { id: "res-002", name: "auth-service", type: "Service", status: "running", region: "us-east-1", created: "2024-01-12" },
  { id: "res-003", name: "billing-db", type: "Database", status: "running", region: "us-west-2", created: "2024-02-01" },
  { id: "res-004", name: "worker-pool", type: "Compute", status: "running", region: "eu-west-1", created: "2024-02-10" },
  { id: "res-005", name: "cdn-assets", type: "CDN", status: "running", region: "global", created: "2024-01-20" },
  { id: "res-006", name: "staging-env", type: "Environment", status: "stopped", region: "us-east-1", created: "2024-03-01" },
  { id: "res-007", name: "monitoring", type: "Service", status: "degraded", region: "us-east-1", created: "2024-01-18" },
  { id: "res-008", name: "cache-layer", type: "Cache", status: "running", region: "us-east-1", created: "2024-02-15" },
]
  ...
  return (
    <span class={`inline-flex items-center rounded-full px-2 py-0.5 text-xs font-medium ${colors()}`}>
      <span class={`mr-1.5 h-1.5 w-1.5 rounded-full ${
        props.status === "running" ? "bg-green-500" :
        props.status === "stopped" ? "bg-gray-400" : "bg-yellow-500"
      }`} />
      {props.status}
    </span>
  )
      ...
      <div>
        <Breadcrumb.Root class="mb-2">
          <Breadcrumb.List class="flex items-center gap-1.5 text-sm text-gray-500">
            ...
            <Breadcrumb.Item>
              <Breadcrumb.Link href="/resources" current class="text-gray-900 font-medium">Resources</Breadcrumb.Link>
            </Breadcrumb.Item>
          </Breadcrumb.List>
        </Breadcrumb.Root>
            ...
            <tbody class="divide-y divide-gray-200 bg-white">
              {filteredResources().map((resource) => (
                <tr class="hover:bg-gray-50">
                  ...
                  <td class="whitespace-nowrap px-6 py-4 text-sm text-gray-500">{resource.region}</td>
                  <td class="whitespace-nowrap px-6 py-4 text-sm text-gray-500">{resource.created}</td>
