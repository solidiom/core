        ...
        <tbody class="divide-y divide-gray-200 bg-white">
          {props.data.map((record) => (
            <tr class="hover:bg-gray-50">
              <td class="whitespace-nowrap px-6 py-4 text-sm font-medium text-gray-900">{record.user}</td>
              ...
              <td class="whitespace-nowrap px-6 py-4 text-right text-sm text-gray-400">{record.timestamp}</td>
            </tr>
          ))}
        </tbody>
      </table>
