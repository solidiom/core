...
const APPLICATIONS: Application[] = [
  {
    id: "app-001",
    name: "Web Dashboard",
    clientID: "client_7f3a9b2c",
    status: "active",
    scopes: ["read", "write", "admin"],
    redirectUris: ["https://app.example.com/callback"],
    webhookUrl: "https://app.example.com/webhooks",
  ...
  },
  {
    ...
    clientID: "client_9a4e2b6f",
    status: "suspended",
    scopes: ["read"],
    redirectUris: [],
    webhookUrl: "https://analytics.internal.example.com/hooks",
  ...
  },
  {
    ...
    clientID: "client_3c6f8a1d",
    status: "active",
    scopes: ["read", "write"],
    redirectUris: [],
    webhookUrl: "https://ci.example.com/api/webhook",
  ...
  },
  {
    ...
    clientID: "client_1d2e3f4a",
    status: "revoked",
    scopes: ["read"],
    redirectUris: ["legacy://auth"],
    webhookUrl: "",
      ...
      <div>
        <Breadcrumb.Root class="mb-2">
          <Breadcrumb.List class="flex items-center gap-1.5 text-sm text-gray-500">
            ...
            <Breadcrumb.Item>
              <Breadcrumb.Link href="/apps" current class="text-gray-900 font-medium">
                Applications
              </Breadcrumb.Link>
            </Breadcrumb.Item>
          </Breadcrumb.List>
        ...
        <div class="flex items-center justify-between">
          <div>
            ...
            <p class="mt-1 text-sm text-gray-500">
              Register applications, manage OAuth clients, and configure webhooks.
            </p>
          </div>
          <Button.Root
