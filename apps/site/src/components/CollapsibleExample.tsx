...
const COPY: Record<Locale, { triggerOpen: string; triggerClose: string; content: string }> = {
  en: {
    triggerOpen: "Show details",
    triggerClose: "Hide details",
    content:
      "This is the collapsible content. It can contain any information you want to reveal or hide.",
  },
  es: {
    triggerOpen: "Mostrar detalles",
    triggerClose: "Ocultar detalles",
    content:
      "Este es el contenido colapsable. Puede contener cualquier información que desee revelar u ocultar.",
  },
}

export interface CollapsibleExampleProps {
  locale: Locale
}
