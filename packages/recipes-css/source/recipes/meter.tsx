/**
 * Styled Meter — CSS recipe wrapper.
 * Import the stylesheet separately: `import "@solidiom/recipes-css/styles/meter.css"`
 */
...
export interface StyledMeterProps extends Omit<Parameters<typeof Meter.Root>[0], "class"> {
  class?: string
}
