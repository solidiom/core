...
export { runCreate, isValidPackageName, createCleanupJournal, type CreateOptions, type CreateResult, type CleanupJournal, } from "./commands/create";
export { materialize, resolveTemplateSource, type MaterializeOptions, type MaterializeResult, } from "./create/materialize";
export { generateProjectConfig, type GenerateProjectConfigOptions, type GenerateProjectConfigResult, type StylingProfile as CreateStylingProfile, } from "./create/config-gen";
...
export { installSource, type SourceInstallOptions, type SourceInstallResult, } from "./source-install/install";
...
export { detectPackageManager, isPackageManagerName, type DetectedPackageManager, type DetectPackageManagerOptions, type PackageManagerName, type DetectionSource, } from "./package-manager/detect";
export { add as addPackageManagerCommand, addDev as addDevPackageManagerCommand, install as installPackageManagerCommand, exec as execPackageManagerCommand, run as runPackageManagerCommand, dlx as dlxPackageManagerCommand, formatCommand, type PackageManagerCommand, } from "./package-manager/commands";
export { runPackageManager, type RunPackageManagerOptions, type RunPackageManagerResult, } from "./package-manager/exec";
