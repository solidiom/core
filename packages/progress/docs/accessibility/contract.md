...
title: Progress - Accessibility Contract
description: Keyboard, focus, semantic, and consumer responsibilities for Progress.
keywords: [progress, accessibility, keyboard, focus, aria]
locale: en
maturity: draft
product: Progress
...
semantics:
  - 'Carries `data-scope="progress"` and `data-part` attributes on all parts.'
aria: []
consumerDuties:
